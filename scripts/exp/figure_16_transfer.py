#!/usr/bin/env python3
"""Provide the processed CSV for Figure 16: Transfers and recomputation."""
...
def main() -> int:
    if "--run" in sys.argv[1:]:
        sys.argv.remove("--run")
        from ae.figure_16_transfer import main as run_experiment
