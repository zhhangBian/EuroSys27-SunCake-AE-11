#!/usr/bin/env python3
"""Provide the processed CSV for Figure 11: Component ablation."""
...
def main() -> int:
    if "--run" in sys.argv[1:]:
        sys.argv.remove("--run")
        from ae.figure_11_component_ablation import main as run_experiment
