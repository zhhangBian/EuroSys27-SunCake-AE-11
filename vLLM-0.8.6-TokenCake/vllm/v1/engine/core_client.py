...
class EngineCoreClient(ABC):
    ...
    * AsyncMPClient: ZMQ + background proc EngineCore w/ asyncio (for AsyncLLM)
    ...
    async def get_mcp_debug_state_async(self) -> dict[str, Any]:
        raise NotImplementedError
...
class InprocClient(EngineCoreClient):
    ...
    def get_mcp_debug_state(self) -> dict[str, Any]:
        return self.engine_core.get_mcp_debug_state()
...
class SyncMPClient(MPClient):
    ...
    def get_mcp_debug_state(self) -> dict[str, Any]:
        return self.call_utility("get_mcp_debug_state")
...
class AsyncMPClient(MPClient):
    ...
    async def get_mcp_debug_state_async(self) -> dict[str, Any]:
        return await self.call_utility_async("get_mcp_debug_state")
    ...
    async def add_request_to_offload_async(
        self, 
        request_id: str, 
        ...
        await self._send_input(EngineCoreRequestType.MCP_OFFLOAD,
                               (request_id, estimated_time, request_type,
                                started_at))
        
    async def mark_request_finished_async(
        self,
        request_id: str,
        request_type: Optional[str] = None,
    ) -> None:
        await self._send_input(EngineCoreRequestType.MCP_FINISHED,
