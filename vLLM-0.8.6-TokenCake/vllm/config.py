...
class CacheConfig:
    ...
    enable_suncake: bool = False
    """Whether to enable SunCake: KV-cache CPU offloading together with
    agent-aware scheduling. The two are enabled and disabled as one unit."""
...
SchedulerPolicy = Literal["fcfs", "priority", "agent"]
