...
class BlockPool:
    ...
    def get_cached_block(self,
        ...
        block = cached_blocks[first_block_id]
        return block

    def _remove_cached_block_mapping(
        self,
        block: KVCacheBlock,
    ...
    def cache_full_blocks(
        ...
        if num_cached_blocks == 0:
            ...
            prev_block_hash_value = block_hashes[num_cached_blocks - 1].hash_value
    ...
    def _maybe_evict_cached_block(self, block: KVCacheBlock) -> bool:
        ...
        self._remove_cached_block_mapping(block, old_hash)
        related_block = block.related_block
        if related_block is not None and related_block.related_block is block:
            related_block.related_block = None
