...
class Request:
    ...
    def __init__(
        ...
        self.priority = priority or self.agent_info.get("priority", None) or 0
    ...
    @property
    def agent_info(self) -> Optional[dict]:
        return self.sampling_params.agent_info or {}

    @property
    def agent_type(self) -> str:
        return self.agent_info.get("type", "")
...
_FINISHED_REASON_MAP = {
    ...
    RequestStatus.FINISHED_PREEMPTED: FinishReason.STOP,
}
