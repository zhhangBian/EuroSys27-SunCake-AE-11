...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        help=(
            "Fraction of GPU memory to use for model execution. "
            "When set, Parrot auto-computes num_kv_cache_blocks after model load."
        ),
    )
    ...
    parser.add_argument(
        "--num-kv-cache-blocks",
        "--num_kv_cache_blocks",
        dest="num_kv_cache_blocks",
        type=int,
        help="Explicit number of KV cache blocks for the builtin engine.",
    )
    ...
    if args.gpu_memory_utilization is not None:
        override_args["gpu_memory_utilization"] = args.gpu_memory_utilization
    if args.num_kv_cache_blocks is not None:
        override_args["num_kv_cache_blocks"] = args.num_kv_cache_blocks
